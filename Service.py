...
#weight_g='C:/Users/CLOUDSEALS/Projects/Workplace_Safety/Manufacturing_safety_PPE/yolo_Model/final_data/runs_weights1/detect/yolov8n_augmented4/weights/best.pt'
weight_g='C:/Users/CLOUDSEALS/Projects/Workplace_Safety/Manufacturing_safety_PPE/yolo_Model/final_data/runs/detect/yolov8n_augmented/weights/best.pt'
...
def get_coordinates_graphic(images_path):
    classes = ['mask', 'no_mask', 'glove', 'no_glove', 'helmet', 'no_helmet', 'goggles', 'no_goggles', 'suit', 'no_suit', 'shoes', 'no_shoes']
...
def defect_detection():    
    if flask.request.method == 'POST':
        ...
        try:
            ...
            print(display_text)
            return render_template('1index_old.html', display_text= display_text, input_image=full_path, output_image=output_image_path, random=random_value, timestamp=timestamp)
